...
var seatNumber = sessionStorage.getItem('seatNumber');
var insuranceType = sessionStorage.getItem('insuranceType');
      ...
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return fetch('https://buses.pridezm.com/api/pay-query', {
            ...
            body: JSON.stringify({
              pending_id: sessionStorage.getItem('pendingId')
            })
          });
        case 3:
...
var intervalId = setInterval(makeRequest, interval);
setTimeout(function () {
