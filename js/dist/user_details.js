...
function _getSeats() {
  _getSeats = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var response, seatData, selectElement;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return fetch("https://buses.pridezm.com/api/seats?route-id=".concat(routeId, "&departure-date=").concat(departureDate), {
            headers: {
        ...
        case 2:
          ...
          return response.json();
        case 5:
          seatData = _context3.sent;
          selectElement = document.querySelector(".seat-select");
          Object.entries(seatData).forEach(function (_ref) {
            var _ref2 = _slicedToArray(_ref, 2),
              seatNum = _ref2[0],
              availability = _ref2[1];
            var optionElement = document.createElement("option");
            optionElement.value = seatNum;
            optionElement.text = function () {
              if (availability === "taken") return "".concat(seatNum, " - Taken");else {
                return "".concat(seatNum, " - Available");
              }
...
function getInsuranceStatus() {
  return _getInsuranceStatus.apply(this, arguments);
}
function _getInsuranceStatus() {
  _getInsuranceStatus = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    var response, insuranceStatus;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return fetch("https://buses.pridezm.com/api/insurance-status?bus-company=".concat(company_id), {
            headers: {
              Authorization: "Token ".concat(token)
            }
          });
        case 2:
          ...
          return response.json();
        case 5:
          insuranceStatus = _context4.sent;
          sessionStorage.setItem('insuranceStatus', insuranceStatus);
          return _context4.abrupt("return", insuranceStatus);
        case 8:
        case "end":
...
function getInsuranceTypes() {
  return _getInsuranceTypes.apply(this, arguments);
}
function _getInsuranceTypes() {
  _getInsuranceTypes = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
    var response, insuranceTypes, insuranceSelect;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.next = 2;
          return fetch("https://buses.pridezm.com/api/insurance-types?insurance-status=".concat(sessionStorage.getItem('insuranceStatus')), {
            headers: {
              Authorization: "Token ".concat(token)
            }
          });
        case 2:
          ...
          return response.json();
        case 5:
          insuranceTypes = _context5.sent;
          sessionStorage.setItem('insuranceTypes', insuranceTypes);
          insuranceSelect = document.querySelector('.insurance-select');
          insuranceTypes.forEach(function (insuranceType) {
            var option = document.createElement('option');
            option.value = insuranceType.id;
            option.text = "ZMW".concat(insuranceType.cost, " - ZMW").concat(insuranceType.return_value, " - ").concat(insuranceType.name);
...
form.addEventListener("submit", function (event) {
  ...
  var seatNumber = formData.get("seat-number");
  var insuranceType = formData.get("insurance-type");
